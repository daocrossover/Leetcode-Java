...
/* Solution
With 2 pigs, poison killing in 15 minutes,
and having 60 minutes, we can find the poison in up to 25 buckets in the following way.
...
one drinks layers from front to back).
