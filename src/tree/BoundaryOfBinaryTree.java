...
public class BoundaryOfBinaryTree {
    public List<Integer> boundaryOfBinaryTree(TreeNode root) {
        ...
        // add root into the res first
        if (root.left != null || root.right != null) {
            res.add(root.val);
        }
        getLeftBound(root.left, res);
        getLeaves(root, res);
        getRightBound(root.right, res);
        return res;
    }

    private void getLeftBound(TreeNode root, List<Integer> res) {
    ...
    private void getRightBound(TreeNode root, List<Integer> res) {
        // if the current node is a leaf node, return
        if (root == null || root.left == null && root.right == null) {
            return;
        }
